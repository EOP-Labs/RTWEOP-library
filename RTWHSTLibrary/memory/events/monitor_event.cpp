...
//	o_GovernorPlugInCompleted                                       = (t_GovernorPlugInCompleted)offsets.onGovernorPlugInCompleted;
	...
	DETOUR_ATTACH(o_FactionTurnStart								, onFactionTurnStart);
	DETOUR_ATTACH(o_FactionWarDeclared								, onFactionWarDeclared);
	DETOUR_ATTACH(o_HordeFormed										, onHordeFormed);
	DETOUR_ATTACH(o_FactionTurnEnd									, onFactionTurnEnd);
	DETOUR_ATTACH(o_HireMercenaries									, onHireMercenaries);
	DETOUR_ATTACH(o_GeneralCaptureResidence							, onGeneralCaptureResidence);
	DETOUR_ATTACH(o_GeneralCaptureWonder							, onGeneralCaptureWonder);
	DETOUR_ATTACH(o_GeneralCaptureSettlement						, onGeneralCaptureSettlement);
	DETOUR_ATTACH(o_LeaderDestroyedFaction							, onLeaderDestroyedFaction);
	DETOUR_ATTACH(o_Disaster										, onDisaster);
	DETOUR_ATTACH(o_CharacterDamagedByDisaster						, onCharacterDamagedByDisaster);
	DETOUR_ATTACH(o_GeneralAssaultsResidence						, onGeneralAssaultsResidence);
	DETOUR_ATTACH(o_OfferedForAdoption								, onOfferedForAdoption);
	DETOUR_ATTACH(o_LesserGeneralOfferedForAdoption					, onLesserGeneralOfferedForAdoption);
	DETOUR_ATTACH(o_OfferedForMarriage								, onOfferedForMarriage);
	DETOUR_ATTACH(o_BrotherAdopted									, onBrotherAdopted);
	DETOUR_ATTACH(o_BecomesFactionLeader							, onBecomesFactionLeader);
	DETOUR_ATTACH(o_BecomesFactionHeir								, onBecomesFactionHeir);
	DETOUR_ATTACH(o_BecomeQuaestor									, onBecomeQuaestor);
	DETOUR_ATTACH(o_BecomeAedile									, onBecomeAedile);
	DETOUR_ATTACH(o_BecomePraetor									, onBecomePraetor);
	DETOUR_ATTACH(o_BecomeConsul									, onBecomeConsul);
	DETOUR_ATTACH(o_BecomeCensor									, onBecomeCensor);
	DETOUR_ATTACH(o_BecomePontifexMaximus							, onBecomePontifexMaximus);
	DETOUR_ATTACH(o_CeasedFactionLeader								, onCeasedFactionLeader);
	DETOUR_ATTACH(o_CeasedFactionHeir								, onCeasedFactionHeir);
	DETOUR_ATTACH(o_CeasedQuaestor									, onCeasedQuaestor);
	DETOUR_ATTACH(o_CeasedAedile									, onCeasedAedile);
	DETOUR_ATTACH(o_CeasedPraetor									, onCeasedPraetor);
	DETOUR_ATTACH(o_CeasedConsul									, onCeasedConsul);
	DETOUR_ATTACH(o_CeasedCensor									, onCeasedCensor);
	DETOUR_ATTACH(o_CeasedPontifexMaximus							, onCeasedPontifexMaximus);
	DETOUR_ATTACH(o_UngarrisonedFort								, onUngarrisonedFort);
	DETOUR_ATTACH(o_LostLegionaryEagle								, onLostLegionaryEagle);
	DETOUR_ATTACH(o_CapturedLegionaryEagle							, onCapturedLegionaryEagle);
//	DETOUR_ATTACH(o_RecapturedLegionaryEagle						, onRecapturedLegionaryEagle);
	DETOUR_ATTACH(o_SenateExposure									, onSenateExposure);
	DETOUR_ATTACH(o_QuaestorInvestigationMinor						, onQuaestorInvestigationMinor);
	DETOUR_ATTACH(o_QuaestorInvestigation							, onQuaestorInvestigation);
	DETOUR_ATTACH(o_QuaestorInvestigationMajor						, onQuaestorInvestigationMajor);
//	DETOUR_ATTACH(o_PopularSupportForOverthrow						, onPopularSupportForOverthrow);
//	DETOUR_ATTACH(o_SenateReadyToOutlawFaction						, onSenateReadyToOutlawFaction);
	DETOUR_ATTACH(o_SenateOutlawsFaction							, onSenateOutlawsFaction);
	DETOUR_ATTACH(o_CharacterSelected								, onCharacterSelected);
	DETOUR_ATTACH(o_SettlementSelected								, onSettlementSelected);
	DETOUR_ATTACH(o_MultiTurnMove									, onMultiTurnMove);
	DETOUR_ATTACH(o_CharacterPanelOpen								, onCharacterPanelOpen);
	DETOUR_ATTACH(o_SettlementPanelOpen								, onSettlementPanelOpen);
	DETOUR_ATTACH(o_FinancesPanelOpen								, onFinancesPanelOpen);
	DETOUR_ATTACH(o_FactionSummaryPanelOpen							, onFactionSummaryPanelOpen);
	DETOUR_ATTACH(o_FamilyTreePanelOpen								, onFamilyTreePanelOpen);
//	DETOUR_ATTACH(o_DiplomaticStandingPanelOpen						, onDiplomaticStandingPanelOpen);
//	DETOUR_ATTACH(o_SenateMissionsPanelOpen							, onSenateMissionsPanelOpen);
	DETOUR_ATTACH(o_SenateOfficesPanelOpen							, onSenateOfficesPanelOpen);
	DETOUR_ATTACH(o_DiplomacyPanelOpen								, onDiplomacyPanelOpen);
	DETOUR_ATTACH(o_PreBattlePanelOpen								, onPreBattlePanelOpen);
//	DETOUR_ATTACH(o_RecruitmentPanelOpen							, onRecruitmentPanelOpen);
//	DETOUR_ATTACH(o_ConstructionPanelOpen							, onConstructionPanelOpen);
	DETOUR_ATTACH(o_TradePanelOpen									, onTradePanelOpen);
//	DETOUR_ATTACH(o_HireMercenariesPanelOpen						, onHireMercenariesPanelOpen);
//	DETOUR_ATTACH(o_NavalAutoResolvePanelOpen						, onNavalAutoResolvePanelOpen);
	DETOUR_ATTACH(o_IncomingMessage									, onIncomingMessage);
	DETOUR_ATTACH(o_MessageOpen										, onMessageOpen);
	DETOUR_ATTACH(o_RequestBuildingAdvice							, onRequestBuildingAdvice);
	DETOUR_ATTACH(o_RequestTrainingAdvice							, onRequestTrainingAdvice);
//	DETOUR_ATTACH(o_RequestMercenariesAdvice						, onRequestMercenariesAdvice);
	DETOUR_ATTACH(o_ButtonPressed									, onButtonPressed);
	DETOUR_ATTACH(o_ShortcutTriggered								, onShortcutTriggered);
	DETOUR_ATTACH(o_ScrollOpened									, onScrollOpened);
	DETOUR_ATTACH(o_ScrollClosed									, onScrollClosed);
//	DETOUR_ATTACH(o_AdviceSupressed									, onAdviceSupressed);
	DETOUR_ATTACH(o_ScrollAdviceRequested							, onScrollAdviceRequested);
//	DETOUR_ATTACH(o_PreBattleScrollAdviceRequested					, onPreBattleScrollAdviceRequested);
//	DETOUR_ATTACH(o_NavalPreBattleScrollAdviceRequested				, onNavalPreBattleScrollAdviceRequested);
	DETOUR_ATTACH(o_SettlementScrollAdviceRequested					, onSettlementScrollAdviceRequested);
//	DETOUR_ATTACH(o_Idle											, onIdle);
//	DETOUR_ATTACH(o_AbandonShowMe									, onAbandonShowMe);
//	DETOUR_ATTACH(o_ScriptedAdvice									, onScriptedAdvice);
//	DETOUR_ATTACH(o_DeclineAutomatedSettlementManagement			, onDeclineAutomatedSettlementManagement);
//	DETOUR_ATTACH(o_EscPressed										, onEscPressed);
	DETOUR_ATTACH(o_GameReloaded									, onGameReloaded);
	DETOUR_ATTACH(o_SettlementTurnStart								, onSettlementTurnStart);
	DETOUR_ATTACH(o_SettlementTurnEnd								, onSettlementTurnEnd);
	DETOUR_ATTACH(o_NewAdmiralCreated								, onNewAdmiralCreated);
	DETOUR_ATTACH(o_UnitTrained										, onUnitTrained);
	DETOUR_ATTACH(o_GovernorUnitTrained								, onGovernorUnitTrained);
	DETOUR_ATTACH(o_BuildingCompleted								, onBuildingCompleted);
	DETOUR_ATTACH(o_GovernorBuildingCompleted						, onGovernorBuildingCompleted);
//	DETOUR_ATTACH(o_PlugInCompleted									, onPlugInCompleted);
//	DETOUR_ATTACH(o_GovernorPlugInCompleted							, onGovernorPlugInCompleted);
	DETOUR_ATTACH(o_AgentCreated									, onAgentCreated);
	DETOUR_ATTACH(o_GovernorAgentCreated							, onGovernorAgentCreated);
	DETOUR_ATTACH(o_BuildingDestroyed								, onBuildingDestroyed);
	DETOUR_ATTACH(o_GovernorBuildingDestroyed						, onGovernorBuildingDestroyed);
	DETOUR_ATTACH(o_CityRiots										, onCityRiots);
	DETOUR_ATTACH(o_GovernorCityRiots								, onGovernorCityRiots);
	DETOUR_ATTACH(o_CityRebels										, onCityRebels);
	DETOUR_ATTACH(o_GovernorCityRebels								, onGovernorCityRebels);
	DETOUR_ATTACH(o_GovernorThrowGames								, onGovernorThrowGames);
	DETOUR_ATTACH(o_GovernorThrowRaces								, onGovernorThrowRaces);
	DETOUR_ATTACH(o_UngarrisonedSettlement							, onUngarrisonedSettlement);
	DETOUR_ATTACH(o_EnslavePopulation								, onEnslavePopulation);
	DETOUR_ATTACH(o_ExterminatePopulation							, onExterminatePopulation);
	DETOUR_ATTACH(o_CitySacked										, onCitySacked);
	DETOUR_ATTACH(o_PreBattle										, onPreBattle);
	DETOUR_ATTACH(o_PreBattleWithdrawal								, onPreBattleWithdrawal);
	DETOUR_ATTACH(o_BattleAiCommenced								, onBattleAiCommenced);
	DETOUR_ATTACH(o_BattleDelayPhaseCommenced						, onBattleDelayPhaseCommenced);
	DETOUR_ATTACH(o_BattleDeploymentPhaseCommenced					, onBattleDeploymentPhaseCommenced);
	DETOUR_ATTACH(o_BattleConflictPhaseCommenced					, onBattleConflictPhaseCommenced);
	DETOUR_ATTACH(o_BattlePlayerUnitAttacksEnemyUnit				, onBattlePlayerUnitAttacksEnemyUnit);
	DETOUR_ATTACH(o_BattleEnemyUnitAttacksPlayerUnit				, onBattleEnemyUnitAttacksPlayerUnit);
	DETOUR_ATTACH(o_BattlePlayerAttacksSettlementBuilding			, onBattlePlayerAttacksSettlementBuilding);
	DETOUR_ATTACH(o_BattleEnemyAttacksSettlementBuilding			, onBattleEnemyAttacksSettlementBuilding);
	DETOUR_ATTACH(o_BattleUnitGoesBerserk							, onBattleUnitGoesBerserk);
	DETOUR_ATTACH(o_BattlePlayerUnitGoesBerserk						, onBattlePlayerUnitGoesBerserk);
	DETOUR_ATTACH(o_BattleEnemyUnitGoesBerserk						, onBattleEnemyUnitGoesBerserk);
	DETOUR_ATTACH(o_BattleUnitRouts									, onBattleUnitRouts);
	DETOUR_ATTACH(o_BattlePlayerUnitRouts							, onBattlePlayerUnitRouts);
	DETOUR_ATTACH(o_BattleEnemyUnitRouts							, onBattleEnemyUnitRouts);
	DETOUR_ATTACH(o_BattlePlayerSiegeEngineDestroyed				, onBattlePlayerSiegeEngineDestroyed);
	DETOUR_ATTACH(o_BattleEnemySiegeEngineDestroyed					, onBattleEnemySiegeEngineDestroyed);
	DETOUR_ATTACH(o_PostBattle										, onPostBattle);
	DETOUR_ATTACH(o_BattleArmyRouted								, onBattleArmyRouted);
	DETOUR_ATTACH(o_BattleGeneralKilled								, onBattleGeneralKilled);
	DETOUR_ATTACH(o_BattleGeneralRouted								, onBattleGeneralRouted);
	DETOUR_ATTACH(o_BattleReinforcementsArrive						, onBattleReinforcementsArrive);
	DETOUR_ATTACH(o_BattleSiegeEngineDestroyed						, onBattleSiegeEngineDestroyed);
	DETOUR_ATTACH(o_BattleSiegeEngineDocksWall						, onBattleSiegeEngineDocksWall);
	DETOUR_ATTACH(o_BattleGatesAttackedByEngine						, onBattleGatesAttackedByEngine);
	DETOUR_ATTACH(o_BattleGatesAttackedByPlayerEngine				, onBattleGatesAttackedByPlayerEngine);
	DETOUR_ATTACH(o_BattleGatesAttackedByEnemyEngine				, onBattleGatesAttackedByEnemyEngine);
	DETOUR_ATTACH(o_BattleBattleGatesDestroyedByEngine				, onBattleBattleGatesDestroyedByEngine);
	DETOUR_ATTACH(o_BattleWallsBreachedByEngine						, onBattleWallsBreachedByEngine);
	DETOUR_ATTACH(o_BattleWallsCaptured								, onBattleWallsCaptured);
	DETOUR_ATTACH(o_BattleFinished									, onBattleFinished);
	DETOUR_ATTACH(o_Birth											, onBirth);
	DETOUR_ATTACH(o_CharacterComesOfAge								, onCharacterComesOfAge);
	DETOUR_ATTACH(o_CharacterMarries								, onCharacterMarries);
	DETOUR_ATTACH(o_CharacterBecomesAFather							, onCharacterBecomesAFather);
	DETOUR_ATTACH(o_CharacterTurnStart								, onCharacterTurnStart);
	DETOUR_ATTACH(o_CharacterTurnEnd								, onCharacterTurnEnd);
	DETOUR_ATTACH(o_CharacterTurnEndInSettlement					, onCharacterTurnEndInSettlement);
	DETOUR_ATTACH(o_GeneralDevastatesTile							, onGeneralDevastatesTile);
	DETOUR_ATTACH(o_SpyMission										, onSpyMission);
	DETOUR_ATTACH(o_ExecutesASpyOnAMission							, onExecutesASpyOnAMission);
	DETOUR_ATTACH(o_LeaderOrderedSpyingMission						, onLeaderOrderedSpyingMission);
	DETOUR_ATTACH(o_AssassinationMission							, onAssassinationMission);
	DETOUR_ATTACH(o_ExecutesAnAssassinOnAMission					, onExecutesAnAssassinOnAMission);
	DETOUR_ATTACH(o_LeaderOrderedAssassination						, onLeaderOrderedAssassination);
	DETOUR_ATTACH(o_SufferAssassinationAttempt						, onSufferAssassinationAttempt);
	DETOUR_ATTACH(o_SabotageMission									, onSabotageMission);
	DETOUR_ATTACH(o_LeaderOrderedSabotage							, onLeaderOrderedSabotage);
	DETOUR_ATTACH(o_BriberyMission									, onBriberyMission);
	DETOUR_ATTACH(o_LeaderOrderedBribery							, onLeaderOrderedBribery);
	DETOUR_ATTACH(o_AcceptBribe										, onAcceptBribe);
	DETOUR_ATTACH(o_RefuseBribe										, onRefuseBribe);
	DETOUR_ATTACH(o_Insurrection									, onInsurrection);
	DETOUR_ATTACH(o_DiplomacyMission								, onDiplomacyMission);
	DETOUR_ATTACH(o_LeaderOrderedDiplomacy							, onLeaderOrderedDiplomacy);
	DETOUR_ATTACH(o_LeaderSenateMissionSuccess						, onLeaderSenateMissionSuccess);
	DETOUR_ATTACH(o_LeaderSenateMissionFailed						, onLeaderSenateMissionFailed);
}
...
void monitor_event::deInitGameEvents()
{
	...
	DETOUR_DETACH(o_FactionTurnStart								, onFactionTurnStart);
	DETOUR_DETACH(o_FactionWarDeclared								, onFactionWarDeclared);
	DETOUR_DETACH(o_HordeFormed										, onHordeFormed);
	DETOUR_DETACH(o_FactionTurnEnd									, onFactionTurnEnd);
	DETOUR_DETACH(o_HireMercenaries									, onHireMercenaries);
	DETOUR_DETACH(o_GeneralCaptureResidence							, onGeneralCaptureResidence);
	DETOUR_DETACH(o_GeneralCaptureWonder							, onGeneralCaptureWonder);
	DETOUR_DETACH(o_GeneralCaptureSettlement						, onGeneralCaptureSettlement);
	DETOUR_DETACH(o_LeaderDestroyedFaction							, onLeaderDestroyedFaction);
	DETOUR_DETACH(o_Disaster										, onDisaster);
	DETOUR_DETACH(o_CharacterDamagedByDisaster						, onCharacterDamagedByDisaster);
	DETOUR_DETACH(o_GeneralAssaultsResidence						, onGeneralAssaultsResidence);
	DETOUR_DETACH(o_OfferedForAdoption								, onOfferedForAdoption);
	DETOUR_DETACH(o_LesserGeneralOfferedForAdoption					, onLesserGeneralOfferedForAdoption);
	DETOUR_DETACH(o_OfferedForMarriage								, onOfferedForMarriage);
	DETOUR_DETACH(o_BrotherAdopted									, onBrotherAdopted);
	DETOUR_DETACH(o_BecomesFactionLeader							, onBecomesFactionLeader);
	DETOUR_DETACH(o_BecomesFactionHeir								, onBecomesFactionHeir);
	DETOUR_DETACH(o_BecomeQuaestor									, onBecomeQuaestor);
	DETOUR_DETACH(o_BecomeAedile									, onBecomeAedile);
	DETOUR_DETACH(o_BecomePraetor									, onBecomePraetor);
	DETOUR_DETACH(o_BecomeConsul									, onBecomeConsul);
	DETOUR_DETACH(o_BecomeCensor									, onBecomeCensor);
	DETOUR_DETACH(o_BecomePontifexMaximus							, onBecomePontifexMaximus);
	DETOUR_DETACH(o_CeasedFactionLeader								, onCeasedFactionLeader);
	DETOUR_DETACH(o_CeasedFactionHeir								, onCeasedFactionHeir);
	DETOUR_DETACH(o_CeasedQuaestor									, onCeasedQuaestor);
	DETOUR_DETACH(o_CeasedAedile									, onCeasedAedile);
	DETOUR_DETACH(o_CeasedPraetor									, onCeasedPraetor);
	DETOUR_DETACH(o_CeasedConsul									, onCeasedConsul);
	DETOUR_DETACH(o_CeasedCensor									, onCeasedCensor);
	DETOUR_DETACH(o_CeasedPontifexMaximus							, onCeasedPontifexMaximus);
	DETOUR_DETACH(o_UngarrisonedFort								, onUngarrisonedFort);
	DETOUR_DETACH(o_LostLegionaryEagle								, onLostLegionaryEagle);
	DETOUR_DETACH(o_CapturedLegionaryEagle							, onCapturedLegionaryEagle);
//	DETOUR_DETACH(o_RecapturedLegionaryEagle						, onRecapturedLegionaryEagle);
	DETOUR_DETACH(o_SenateExposure									, onSenateExposure);
	DETOUR_DETACH(o_QuaestorInvestigationMinor						, onQuaestorInvestigationMinor);
	DETOUR_DETACH(o_QuaestorInvestigation							, onQuaestorInvestigation);
	DETOUR_DETACH(o_QuaestorInvestigationMajor						, onQuaestorInvestigationMajor);
//	DETOUR_DETACH(o_PopularSupportForOverthrow						, onPopularSupportForOverthrow);
//	DETOUR_DETACH(o_SenateReadyToOutlawFaction						, onSenateReadyToOutlawFaction);
	DETOUR_DETACH(o_SenateOutlawsFaction							, onSenateOutlawsFaction);
	DETOUR_DETACH(o_CharacterSelected								, onCharacterSelected);
	DETOUR_DETACH(o_SettlementSelected								, onSettlementSelected);
	DETOUR_DETACH(o_MultiTurnMove									, onMultiTurnMove);
	DETOUR_DETACH(o_CharacterPanelOpen								, onCharacterPanelOpen);
	DETOUR_DETACH(o_SettlementPanelOpen								, onSettlementPanelOpen);
	DETOUR_DETACH(o_FinancesPanelOpen								, onFinancesPanelOpen);
	DETOUR_DETACH(o_FactionSummaryPanelOpen							, onFactionSummaryPanelOpen);
	DETOUR_DETACH(o_FamilyTreePanelOpen								, onFamilyTreePanelOpen);
//	DETOUR_DETACH(o_DiplomaticStandingPanelOpen						, onDiplomaticStandingPanelOpen);
//	DETOUR_DETACH(o_SenateMissionsPanelOpen							, onSenateMissionsPanelOpen);
	DETOUR_DETACH(o_SenateOfficesPanelOpen							, onSenateOfficesPanelOpen);
	DETOUR_DETACH(o_DiplomacyPanelOpen								, onDiplomacyPanelOpen);
	DETOUR_DETACH(o_PreBattlePanelOpen								, onPreBattlePanelOpen);
//	DETOUR_DETACH(o_RecruitmentPanelOpen							, onRecruitmentPanelOpen);
//	DETOUR_DETACH(o_ConstructionPanelOpen							, onConstructionPanelOpen);
	DETOUR_DETACH(o_TradePanelOpen									, onTradePanelOpen);
//	DETOUR_DETACH(o_HireMercenariesPanelOpen						, onHireMercenariesPanelOpen);
//	DETOUR_DETACH(o_NavalAutoResolvePanelOpen						, onNavalAutoResolvePanelOpen);
	DETOUR_DETACH(o_IncomingMessage									, onIncomingMessage);
	DETOUR_DETACH(o_MessageOpen										, onMessageOpen);
	DETOUR_DETACH(o_RequestBuildingAdvice							, onRequestBuildingAdvice);
	DETOUR_DETACH(o_RequestTrainingAdvice							, onRequestTrainingAdvice);
//	DETOUR_DETACH(o_RequestMercenariesAdvice						, onRequestMercenariesAdvice);
	DETOUR_DETACH(o_ButtonPressed									, onButtonPressed);
	DETOUR_DETACH(o_ShortcutTriggered								, onShortcutTriggered);
	DETOUR_DETACH(o_ScrollOpened									, onScrollOpened);
	DETOUR_DETACH(o_ScrollClosed									, onScrollClosed);
//	DETOUR_DETACH(o_AdviceSupressed									, onAdviceSupressed);
	DETOUR_DETACH(o_ScrollAdviceRequested							, onScrollAdviceRequested);
//	DETOUR_DETACH(o_PreBattleScrollAdviceRequested					, onPreBattleScrollAdviceRequested);
//	DETOUR_DETACH(o_NavalPreBattleScrollAdviceRequested				, onNavalPreBattleScrollAdviceRequested);
	DETOUR_DETACH(o_SettlementScrollAdviceRequested					, onSettlementScrollAdviceRequested);
//	DETOUR_DETACH(o_Idle											, onIdle);
//	DETOUR_DETACH(o_AbandonShowMe									, onAbandonShowMe);
//	DETOUR_DETACH(o_ScriptedAdvice									, onScriptedAdvice);
//	DETOUR_DETACH(o_DeclineAutomatedSettlementManagement			, onDeclineAutomatedSettlementManagement);
//	DETOUR_DETACH(o_EscPressed										, onEscPressed);
	DETOUR_DETACH(o_GameReloaded									, onGameReloaded);
	DETOUR_DETACH(o_SettlementTurnStart								, onSettlementTurnStart);
	DETOUR_DETACH(o_SettlementTurnEnd								, onSettlementTurnEnd);
	DETOUR_DETACH(o_NewAdmiralCreated								, onNewAdmiralCreated);
	DETOUR_DETACH(o_UnitTrained										, onUnitTrained);
	DETOUR_DETACH(o_GovernorUnitTrained								, onGovernorUnitTrained);
	DETOUR_DETACH(o_BuildingCompleted								, onBuildingCompleted);
	DETOUR_DETACH(o_GovernorBuildingCompleted						, onGovernorBuildingCompleted);
//	DETOUR_DETACH(o_PlugInCompleted									, onPlugInCompleted);
//	DETOUR_DETACH(o_GovernorPlugInCompleted							, onGovernorPlugInCompleted);
	DETOUR_DETACH(o_AgentCreated									, onAgentCreated);
	DETOUR_DETACH(o_GovernorAgentCreated							, onGovernorAgentCreated);
	DETOUR_DETACH(o_BuildingDestroyed								, onBuildingDestroyed);
	DETOUR_DETACH(o_GovernorBuildingDestroyed						, onGovernorBuildingDestroyed);
	DETOUR_DETACH(o_CityRiots										, onCityRiots);
	DETOUR_DETACH(o_GovernorCityRiots								, onGovernorCityRiots);
	DETOUR_DETACH(o_CityRebels										, onCityRebels);
	DETOUR_DETACH(o_GovernorCityRebels								, onGovernorCityRebels);
	DETOUR_DETACH(o_GovernorThrowGames								, onGovernorThrowGames);
	DETOUR_DETACH(o_GovernorThrowRaces								, onGovernorThrowRaces);
	DETOUR_DETACH(o_UngarrisonedSettlement							, onUngarrisonedSettlement);
	DETOUR_DETACH(o_EnslavePopulation								, onEnslavePopulation);
	DETOUR_DETACH(o_ExterminatePopulation							, onExterminatePopulation);
	DETOUR_DETACH(o_CitySacked										, onCitySacked);
	DETOUR_DETACH(o_PreBattle										, onPreBattle);
	DETOUR_DETACH(o_PreBattleWithdrawal								, onPreBattleWithdrawal);
	DETOUR_DETACH(o_BattleAiCommenced								, onBattleAiCommenced);
	DETOUR_DETACH(o_BattleDelayPhaseCommenced						, onBattleDelayPhaseCommenced);
	DETOUR_DETACH(o_BattleDeploymentPhaseCommenced					, onBattleDeploymentPhaseCommenced);
	DETOUR_DETACH(o_BattleConflictPhaseCommenced					, onBattleConflictPhaseCommenced);
	DETOUR_DETACH(o_BattlePlayerUnitAttacksEnemyUnit				, onBattlePlayerUnitAttacksEnemyUnit);
	DETOUR_DETACH(o_BattleEnemyUnitAttacksPlayerUnit				, onBattleEnemyUnitAttacksPlayerUnit);
	DETOUR_DETACH(o_BattlePlayerAttacksSettlementBuilding			, onBattlePlayerAttacksSettlementBuilding);
	DETOUR_DETACH(o_BattleEnemyAttacksSettlementBuilding			, onBattleEnemyAttacksSettlementBuilding);
	DETOUR_DETACH(o_BattleUnitGoesBerserk							, onBattleUnitGoesBerserk);
	DETOUR_DETACH(o_BattlePlayerUnitGoesBerserk						, onBattlePlayerUnitGoesBerserk);
	DETOUR_DETACH(o_BattleEnemyUnitGoesBerserk						, onBattleEnemyUnitGoesBerserk);
	DETOUR_DETACH(o_BattleUnitRouts									, onBattleUnitRouts);
	DETOUR_DETACH(o_BattlePlayerUnitRouts							, onBattlePlayerUnitRouts);
	DETOUR_DETACH(o_BattleEnemyUnitRouts							, onBattleEnemyUnitRouts);
	DETOUR_DETACH(o_BattlePlayerSiegeEngineDestroyed				, onBattlePlayerSiegeEngineDestroyed);
	DETOUR_DETACH(o_BattleEnemySiegeEngineDestroyed					, onBattleEnemySiegeEngineDestroyed);
	DETOUR_DETACH(o_PostBattle										, onPostBattle);
	DETOUR_DETACH(o_BattleArmyRouted								, onBattleArmyRouted);
	DETOUR_DETACH(o_BattleGeneralKilled								, onBattleGeneralKilled);
	DETOUR_DETACH(o_BattleGeneralRouted								, onBattleGeneralRouted);
	DETOUR_DETACH(o_BattleReinforcementsArrive						, onBattleReinforcementsArrive);
	DETOUR_DETACH(o_BattleSiegeEngineDestroyed						, onBattleSiegeEngineDestroyed);
	DETOUR_DETACH(o_BattleSiegeEngineDocksWall						, onBattleSiegeEngineDocksWall);
	DETOUR_DETACH(o_BattleGatesAttackedByEngine						, onBattleGatesAttackedByEngine);
	DETOUR_DETACH(o_BattleGatesAttackedByPlayerEngine				, onBattleGatesAttackedByPlayerEngine);
	DETOUR_DETACH(o_BattleGatesAttackedByEnemyEngine				, onBattleGatesAttackedByEnemyEngine);
	DETOUR_DETACH(o_BattleBattleGatesDestroyedByEngine				, onBattleBattleGatesDestroyedByEngine);
	DETOUR_DETACH(o_BattleWallsBreachedByEngine						, onBattleWallsBreachedByEngine);
	DETOUR_DETACH(o_BattleWallsCaptured								, onBattleWallsCaptured);
	DETOUR_DETACH(o_BattleFinished									, onBattleFinished);
	DETOUR_DETACH(o_Birth											, onBirth);
	DETOUR_DETACH(o_CharacterComesOfAge								, onCharacterComesOfAge);
	DETOUR_DETACH(o_CharacterMarries								, onCharacterMarries);
	DETOUR_DETACH(o_CharacterBecomesAFather							, onCharacterBecomesAFather);
	DETOUR_DETACH(o_CharacterTurnStart								, onCharacterTurnStart);
	DETOUR_DETACH(o_CharacterTurnEnd								, onCharacterTurnEnd);
	DETOUR_DETACH(o_CharacterTurnEndInSettlement					, onCharacterTurnEndInSettlement);
	DETOUR_DETACH(o_GeneralDevastatesTile							, onGeneralDevastatesTile);
	DETOUR_DETACH(o_SpyMission										, onSpyMission);
	DETOUR_DETACH(o_ExecutesASpyOnAMission							, onExecutesASpyOnAMission);
	DETOUR_DETACH(o_LeaderOrderedSpyingMission						, onLeaderOrderedSpyingMission);
	DETOUR_DETACH(o_AssassinationMission							, onAssassinationMission);
	DETOUR_DETACH(o_ExecutesAnAssassinOnAMission					, onExecutesAnAssassinOnAMission);
	DETOUR_DETACH(o_LeaderOrderedAssassination						, onLeaderOrderedAssassination);
	DETOUR_DETACH(o_SufferAssassinationAttempt						, onSufferAssassinationAttempt);
	DETOUR_DETACH(o_SabotageMission									, onSabotageMission);
	DETOUR_DETACH(o_LeaderOrderedSabotage							, onLeaderOrderedSabotage);
	DETOUR_DETACH(o_BriberyMission									, onBriberyMission);
	DETOUR_DETACH(o_LeaderOrderedBribery							, onLeaderOrderedBribery);
	DETOUR_DETACH(o_AcceptBribe										, onAcceptBribe);
	DETOUR_DETACH(o_RefuseBribe										, onRefuseBribe);
	DETOUR_DETACH(o_Insurrection									, onInsurrection);
	DETOUR_DETACH(o_DiplomacyMission								, onDiplomacyMission);
	DETOUR_DETACH(o_LeaderOrderedDiplomacy							, onLeaderOrderedDiplomacy);
	DETOUR_DETACH(o_LeaderSenateMissionSuccess						, onLeaderSenateMissionSuccess);
	DETOUR_DETACH(o_LeaderSenateMissionFailed						, onLeaderSenateMissionFailed);
}
